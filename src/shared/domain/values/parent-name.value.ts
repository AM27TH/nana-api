...
export class ParentName {
  ...
  public static create(firstName: string, lastName: string): ParentName {
    firstName = (firstName ?? "").trim();
    lastName = (lastName ?? "").trim();
    return new ParentName(firstName, lastName);
  }

  public static createv2(firstName: string, lastName: string): Result<AppNotification, ParentName> {
    ...
    return Result.ok(new ParentName(firstName, lastName));
  }
}